...
shap_dir = "/home/bas/Desktop/Paula/GATS/Better/BEST2/PCA genes/BAG/ADDECODE Saving figures/shap_outputs_addecode"
all_shap_dfs = []
...
top10_df = grouped.sort_values(by="SHAP_val", ascending=False).head(10)
...
for _, row in top10_df.iterrows():
    ...
    con_matrix[i, j] = row["SHAP_val"]
    con_matrix[j, i] = row["SHAP_val"]
...
fig.suptitle("AD-DECODE Top 10 DTI Connections by SHAP Value", fontsize=22, y=0.95)
...
# === Save ===
os.makedirs("figs_glass_brain_dti_addecode", exist_ok=True)
fig.savefig("figs_glass_brain_dti_addecode/glass_brain_dti_top10_addecode.png", dpi=300, bbox_inches='tight')
plt.show()
