...
for i, data in enumerate(graph_data_list_addecode[:5]):
...
print(f"# Final check:")
print(f"- Metadata subjects: {len(addecode_healthy_metadata)}")
print(f"- Connectomes: {len(matched_connectomes_healthy_addecode)}")
print(f"- Subject-to-meta tensors: {len(subject_to_meta_addecode)}")
print(f"- Multimodal node features: {len(normalized_node_features_dict)}")
